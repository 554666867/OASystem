...
<div id=MainArea>
    ...
    <s:form action="flowAction_submit" enctype="multipart/form-data">
        <s:hidden name="applicationTemplateId"></s:hidden>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><s:a action="applicationTemplateAction_download?id=%{applicationTemplateId}" cssStyle="text-decoration: underline">[点击下载文档模板文件]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
